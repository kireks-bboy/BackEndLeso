...
$work = 'Front-End';
$live = 'Belarus, Minsk';
$email = 'denviko00@gmail.com';
$phone = '+ 375 29 500 00 0';
$age = 2023-2002;
$days = (2023-2002)*365;
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
         ...
         <?php echo $age ?>  (<?php echo $days ?>дней)
         </p>
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $work; ?></p>
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $live; ?></p>
          ...
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skills ['level'][0]; ?>%"><?php echo $skills ['level'][0]; ?>%
            </div>
          </div>
          <p>Photography</p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
